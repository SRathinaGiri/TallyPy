...
v_xml = (
    ...
    "<COLLECTION NAME=\"V\"><TYPE>Voucher</TYPE><FETCH>Date, VoucherTypeName, VoucherNumber, Narration, PartyLedgerName, PartyGSTIN, IsOptional, AllLedgerEntries.*</FETCH><FILTER>IsAccountingVoucher</FILTER></COLLECTION></TDLMESSAGE></TDL></DESC></BODY></ENVELOPE>"
)
